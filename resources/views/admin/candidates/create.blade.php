                ...
                <form method="POST" action="{{ route('admin.candidates.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea id="details" name="details" class="mt-1 block w-full border-blue-700 bg-blue-950 text-white focus:border-blue-500 focus:ring-blue-500 rounded-md shadow-sm" rows="5">{{ old('details') }}</textarea>
